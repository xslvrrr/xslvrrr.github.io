  ...
  return (
    ...
    >
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          "bg-popover text-popover-foreground data-open:animate-in data-closed:animate-out data-closed:zoom-out-95 data-open:zoom-in-90 ring-foreground/10 rounded-xl shadow-md ring-1 duration-100 origin-top-center relative mt-1.5 w-full overflow-hidden",
          className
        )}
        {...props}
      />
...
function NavigationMenuIndicator({
  ...
  return (
    <NavigationMenuPrimitive.Indicator
      ...
      className={cn(
        "data-[state=visible]:animate-in data-visible:animate-in data-[state=hidden]:animate-out data-hidden:animate-out data-[state=hidden]:fade-out data-hidden:fade-out data-[state=visible]:fade-in data-visible:fade-in top-full z-[1] flex h-1.5 items-end justify-center overflow-hidden",
        className
      )}
      {...props}
    >
