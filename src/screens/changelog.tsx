                            ...
                            <div className={styles.notesBody}>
                                <header className={styles.notesHeader}>
                                    ...
                                    <p className={styles.notesLead}>
                                        ...
                                        ground up and gained an assistant that works on your own data, a full study
                                        system, reports you can mark up, and a dashboard you can rearrange, with a
                                        substantial amount of security and reliability work underneath all of it.
                                    </p>
