                        ...
                        <div className={styles.notesBody}>
                            <header className={styles.notesHeader}>
                                ...
                                <p className={styles.notesLead}>
                                    ...
                                    follows may still not be all of it. The application has been rebuilt from
                                    the ground up, gained a native desktop app, an assistant that works on your
                                    own data, and a study system, with a substantial amount of security and
